<template>
  <div
    class="auth-modal fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-[11] bg-white lg:rounded-[20px] rounded-[10px] lg:py-14 lg:px-12 lg:min-w-[721px] px-9 py-6 max-md:w-[303px]"
  >
    <div
